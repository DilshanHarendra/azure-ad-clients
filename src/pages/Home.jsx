<div className="bg-cover bg-bottom" style="background-image: url('https://source.unsplash.com/Nyvq2juw4_o/1280x400');">
    <div className="bg-gray-800 bg-opacity-90 backdrop-filter backdrop-blur-sm">
        ...
        <header id="page-header" className="flex flex-none items-center py-10">
            <div
                className="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 container xl:max-w-7xl mx-auto px-4 lg:px-8">
                <div>
                    <a href="javascript:void(0)"
                       className="inline-flex items-center space-x-2 font-bold text-lg tracking-wide text-white hover:opacity-75">
                        <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                             className="text-indigo-300 opacity-75 hi-outline hi-cube-transparent inline-block w-6 h-6">
                ...
                <div
                    className="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 md:space-x-10">
                    <nav className="space-x-4 md:space-x-6">
                        <a href="javascript:void(0)" className="font-semibold text-gray-300 hover:text-gray-400">
                            <span>Features</span>
                        </a>
                        <a href="javascript:void(0)" className="font-semibold text-gray-300 hover:text-gray-400">
                            <span>Plans</span>
        ...
        <div className="text-center container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
            <div
                className="font-semibold inline-flex px-2 py-1 leading-4 mb-2 text-sm rounded text-yellow-800 bg-yellow-300">
                v3.0 is now live!
            </div>
            ...
            <h3 className="text-lg md:text-xl md:leading-relaxed font-medium text-gray-400 lg:w-2/3 mx-auto">
                Save, schedule and generate social media posts for all the networks you are part of. Inspiring results
                from first day.
            </h3>
            <div
