...
export const profileEdit = {
    ...
    url: `https://dperera.b2clogin.com/dperera.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_profile_editing&client_id=${msalConfig.auth.clientId}&nonce=defaultNonce&redirect_uri=http://localhost:4000&scope=openid&response_type=id_token&prompt=login`
};
